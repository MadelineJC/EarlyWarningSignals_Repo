...
# (4.1) AR-1 Process with Poisson Distribution
...
```{r}
model <- stan_model("Code/8_SigTesting_AR1-Pois.stan")
```
...
# (4.2) AR-1 Process with Negative Binomial Distribution

## Compiling Model

```{r}
model <- stan_model("Code/8_SigTesting_AR1-NegBinom-AltParm.stan")
```
